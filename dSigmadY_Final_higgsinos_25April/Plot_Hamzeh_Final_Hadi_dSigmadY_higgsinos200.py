...
from dSigmadY_10_100000_10_higgsinos_MN10_tagged_elastic_m200GeV import *

fig, ax = plt.subplots(figsize=(11.0, 9.0))
ax.set_xlim(0.0, 5.0)
ax.set_ylim(0.000003, 0.00004)
...
# Save the plot
plt.savefig("dSigmadY_higgsinos200GeV_25April_m200GeV.pdf")
plt.savefig("dSigmadY_higgsinos200GeV_25April_m200GeV.jpg")
