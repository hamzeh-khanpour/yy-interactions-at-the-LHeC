...
for wv in wlist:
    ...
    if inelastic:
        flux_inel_w = Syy.flux_inel_yy_atW(wv, 50.0, 7000.0, q2emax, mNmax, q2pmax)
        # print(flux_inel_w)
    ...
    flux_el = Syy.flux_el_yy_atW(wv, 50.0, 7000.0, q2emax, q2pmax)
    # print(flux_el)
...
with open('50_100000_1000_ALPHA2PI_MN_Q2_Q2_mMin2_q2min_GRAPE_like_sf.dat', 'w') as f:
