...
// found on file: lpair_higgsino.root
//////////////////////////////////////////////////////////

#ifndef lpair_higgsino_h
#define lpair_higgsino_h
...
//   vector<string>  attribute_string;
   ...
   lpair_higgsino(TTree *tree=0);
   virtual ~lpair_higgsino();
...
#ifdef lpair_higgsino_cxx
lpair_higgsino::lpair_higgsino(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/event_higgsinos_QE_100_100_M100GeV_SuriYennie.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/hepmc3-build/event_higgsinos_QE_100_100_M100GeV_SuriYennie.root");
      }
...
lpair_higgsino::~lpair_higgsino()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t lpair_higgsino::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t lpair_higgsino::LoadTree(Long64_t entry)
{
...
void lpair_higgsino::Init(TTree *tree)
{
...
void lpair_higgsino::Show(Long64_t entry)
{
...
Int_t lpair_higgsino::Cut(Long64_t entry)
{
...
#endif // #ifdef lpair_higgsino_cxx
