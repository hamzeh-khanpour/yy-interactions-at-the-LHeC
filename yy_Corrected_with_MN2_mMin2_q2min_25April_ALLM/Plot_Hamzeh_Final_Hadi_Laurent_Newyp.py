...
output_data = np.column_stack((wv2[:303], int_el1[:303], int_inel[:303]))
...
plt.savefig("yy_int_with_MN2_mMin2_q2min_Final_25April_Modified_Newyp.pdf")
plt.savefig("yy_int_with_MN2_mMin2_q2min_Final_25April_Modified_Newyp.jpg")
