...
plt.ylabel(r"$\sigma_{{\rm ep}\to {\rm e}(\gamma\gamma \to ZZ){\rm p}^{(\ast)}}$ (W > W$_0$) [pb]")


plt.savefig("cs_zz_MN2_mMin2_q2min_Final_25April.pdf")
plt.savefig("cs_zz_MN2_mMin2_q2min_Final_25April.jpg")
