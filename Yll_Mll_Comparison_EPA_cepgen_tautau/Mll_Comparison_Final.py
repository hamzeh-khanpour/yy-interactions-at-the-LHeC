...
##################################################################
    ...
    ax.loglog(wv2, int_el, linestyle='solid', linewidth=2, label='elastic')
    ax.loglog(wv1, int_inel, linestyle='dotted', linewidth=2, label='inelastic')
