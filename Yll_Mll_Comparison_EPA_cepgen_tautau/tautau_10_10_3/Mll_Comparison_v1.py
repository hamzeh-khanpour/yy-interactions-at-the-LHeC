...
def compare_Mll_distributions(filename_root):
    ...
    canvas_Mll.SaveAs("Mll_Comparison_root_mathplotlib_v1_tautau_10_10_3.pdf")
    ...
    ax.legend(title='Inelastic: $M_N<3$ GeV ($Q^2_p<10$ GeV$^2$)', fontsize=15)

    # Save the plot
    plt.savefig("Mll_Comparison_matplotlib_v1_tautau_10_10_3.pdf")
