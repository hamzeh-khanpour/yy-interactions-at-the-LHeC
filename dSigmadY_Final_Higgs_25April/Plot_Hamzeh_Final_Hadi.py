...
from dSigmadY_ep_Higgs_10_100000_100000_tagged_elastic import *
...
plt.xlabel("$Y_{H}$",  fontdict = font2)
plt.ylabel("$d\sigma/dY_{H}$ [pb]", fontdict = font2)


plt.savefig("dSigmadY_Higgs_25April.pdf")
plt.savefig("dSigmadY_Higgs_25April.jpg")
