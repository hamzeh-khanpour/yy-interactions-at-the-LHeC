...
plt.loglog(wv2[:303], int_el[:303], linestyle = 'solid',  linewidth=2,  color='blue', label = 'elastic')
plt.loglog(wv1[:303], int_inel[:303], linestyle = 'dashed',  linewidth=2, color='red', label = inel_label)
...
plt.savefig("cs_higgsionos_MN2_mMin2_q2min_Final_25April_DIS2024.jpg")
