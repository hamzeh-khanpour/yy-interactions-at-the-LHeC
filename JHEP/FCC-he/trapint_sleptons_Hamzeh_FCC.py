...
np.savetxt('output_values_sleptons_FCC.txt', output_data, header=header, fmt='%0.8e', delimiter='\t')
...
plt.ylabel(r"$\sigma_{{\rm ep}\to {\rm e}(\gamma\gamma \to \widetilde{\ell}^+\widetilde{\ell}^-){\rm p}^{(\ast)}}$ (W > W$_0$) [pb]", fontdict = font2)




plt.savefig("cs_sleptons_FCC.pdf")
plt.savefig("cs_sleptons_FCC.jpg")
