...
np.savetxt('output_values_higgsionos_FCC.txt', output_data, header=header, fmt='%0.8e', delimiter='\t')
...
plt.savefig("cs_higgsionos_FCC.pdf")
plt.savefig("cs_higgsionos_FCC.jpg")
