...
# Final Version -- October 2024 -- Hamzeh Khanpour
...
for wv in wlist:
    ...
    if inelastic:
        flux_inel_w = Syy.flux_inel_yy_atW(wv, 60.0, 50000.0, q2emax, mNmax, q2pmax)
        # print(flux_inel_w)
    ...
    flux_el = Syy.flux_el_yy_atW(wv, 60.0, 50000.0, q2emax, q2pmax)
    # print(flux_el)
...
with open('300_100000_100000_FCC.dat', 'w') as f:
