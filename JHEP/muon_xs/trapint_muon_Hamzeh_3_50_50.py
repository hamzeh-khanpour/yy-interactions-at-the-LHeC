...
plt.ylabel(r"$\sigma_{{\rm ep}\to {\rm e}(\gamma\gamma\to\mu^+\mu^-){\rm p}^{(\ast)}}$ (W > W$_0$) [pb]")


plt.savefig("cs_muon_MN2_mMin2_q2min_Final_25April_3_50_50.pdf")  
plt.savefig("cs_muon_MN2_mMin2_q2min_Final_25April_3_50_50.jpg")
