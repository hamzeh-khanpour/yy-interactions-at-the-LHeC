...
from dSigmadY_ep_tautau_3_50_50 import wvalues, elas, inel
...
#    ax.errorbar(bin_centers, hist_Yll_QE, xerr=DX, yerr=hist_Yll_QE_errors,  marker='.', linestyle='None', linewidth=2, color='green', label='quasi-elastic (cepgen)')
    ...
    title_label = ('$Q^2_e<$ $50$ GeV$^2$').format(10, np.log10(inel[1]))
    ax.legend(title=title_label, loc='upper right', fontsize=20)



    # Add text annotations
    info_text_1 = r"$Q^2_p<50$ GeV$^2$"
    ...
    plt.savefig("Yll_Comparison_mu_50_50_3_JHEP.pdf")
    plt.savefig("Yll_Comparison_mu_50_50_3_JHEP.jpg")
...
compare_distributions("LHeC_Compare_mumu_3_50_50.root")
