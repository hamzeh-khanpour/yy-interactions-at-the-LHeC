...
from dSigmadY_ep_tautau_3_10_50 import wvalues, elas, inel
...
#    ax.errorbar(bin_centers, hist_Yll_QE, xerr=DX, yerr=hist_Yll_QE_errors,  marker='.', linestyle='None', linewidth=2, color='green', label='quasi-elastic (cepgen)')
    ...
    plt.savefig("Yll_Comparison_mumu_10_50_3_JHEP.pdf")
    plt.savefig("Yll_Comparison_mumu_10_50_3_JHEP.jpg")
...
compare_distributions("LHeC_Compare_mumu_3_10_50.root")
