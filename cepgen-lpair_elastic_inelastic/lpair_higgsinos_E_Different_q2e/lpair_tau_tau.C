...
//      Yll = Etall -  TMath::Cos(Thetall)/2.0 * (Mtau/Ptll)* (Mtau/Ptll);
      ...
      histq2->Fill(q2,event_weight_BH);
...
Double_t xl1=0.60, yl1=0.60, xl2=xl1+0.0, yl2=yl1+0.0;

TLegend *leg = new TLegend(xl1,yl1,xl2,yl2);
leg->SetBorderSize(0);

leg->AddEntry(histMassdilepton,"Elastic (higgsinos [m = 100 GeV]) cepgen","L")->SetTextColor(kBlue+1);
