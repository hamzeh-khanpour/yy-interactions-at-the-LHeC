...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/cepgen_tautau_QE_3_10_10_W100GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/hepmc3-build/cepgen_tautau_QE_3_10_10_W100GeV.root");
      }
